...
**sample-component-server**: projeto responsável por empacotar todo o sample-component em um arquivo do tipo .ear. Nessa parte também estão os arquivos de configuração do componente:
1) para que o componente seja instalado corretamente, é necessário o arquivo **component.xml**
...
2) para criar a página e já disponibilizar a widget, é necessário o arquivo **pages.xml**
...
3) o packge do projeto deve ser do tipo **.EAR** (Enterprise Application aRchive)
...
1) no arquivo application.info o cógido precisa ser único: **application.code=samplewidget**
