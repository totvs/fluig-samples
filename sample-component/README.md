...
* **sample-component-service**: projeto responsável em criar tabelas no banco de dados, dedicadas apenas a esse app
	...
	<em>Ainda não estão disponíveis os serviços para conectar com as API's Rest. Logo menos, vamos criar esses serviços e disponibilizar nesse mesmo projeto.</em>
